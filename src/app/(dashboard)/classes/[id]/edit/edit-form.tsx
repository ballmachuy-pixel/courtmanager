          ...
          <div className="p-8 bg-black/10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="md:col-span-2">
                    ...
                    <label key={c.id} className="flex items-center gap-3 p-3 rounded-xl hover:bg-white/5 transition-all cursor-pointer border border-transparent hover:border-white/10 group">
                      <div className="relative flex items-center">
                        <input 
                          ...
                          name="coach_ids" 
                          value={c.id} 
                          defaultChecked={defaultCoachIds.includes(c.id)}
                ...
                <p className="text-[10px] text-slate-500 mt-2 italic">* Thầy đầu tiên được tích sẽ được ưu tiên hiển thị làm HLV chính.</p>
              </div>
            </div>
          </div>
        </div>
